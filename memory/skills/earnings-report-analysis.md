...
- 收入增长来自价格、销量、产品结构、区域或并表哪一类驱动
- 毛利率和营业利润率变化是否有明确解释
- 净利润与经营现金流是否匹配
- 应收、存货、递延收入、合同负债是否支持收入质量
- 回购、税率、利息、汇率、减值和调整项是否影响 EPS
- 管理层指引是否与订单、需求、产能或行业数据一致
- 核心业务是否仍是本期增长主来源
...
- 只看同比，不看环比和季节性
- 只看公司口径，不看市场预期和股价已反映程度
- 只引用 management commentary，不核验财务表
- 把短期费用控制误判成经营杠杆改善
