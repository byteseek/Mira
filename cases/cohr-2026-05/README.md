...
- COHR 是 AI datacenter optical infrastructure 的核心受益标的之一。
- 本期财报可以清楚拆分核心业务、核心增长和核心拖累。
- LITE 在相邻日期发布同期财报，适合作为同行交叉验证。
- 案例可检验新版框架中的 `pricing`、`volume`、`durability` 和 `peer earnings cross-check`。
